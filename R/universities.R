...
#'   \item{mascot}{chr Designation of team mascot. Where differentiated, second name indicates preferred feminine form.}
...
#'   \item{url}{chr URL to institutional website}
